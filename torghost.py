...
def logo():
    ...
    print("""
     _______          _____ _               _   _   _  _______   __
    |__   __|        / ____| |             | | | \ | |/ ____\ \ / /
       | | ___  _ __| |  __| |__   ___  ___| |_|  \| | |  __ \ V / 
       | |/ _ \| '__| | |_ | '_ \ / _ \/ __| __| . ` | | |_ | > <  
       | | (_) | |  | |__| | | | | (_) \__ \ |_| |\  | |__| |/ . \ 
       |_|\___/|_|   \_____|_| |_|\___/|___/\__|_| \_|\_____/_/ \_X
                                                                                                                                  
	{V} - origin from github.com/SusmithKrishnan/torghost
          improved by github.com/pthoelken/torghostngx
...
def main():
    ...
    for (o, a) in opts:
        if o in ('-h', '--help'):
            ...
            # check_update()
            print("This function is disabled for now. Check the development progress on github.com/pthoelken/TorghostNGX")
        else:
            usage()
